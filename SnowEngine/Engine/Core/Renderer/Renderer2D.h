...
namespace Snow
{
	...
	public:
		...
		static void DrawQuad(const glm::mat4& transform, Ref<Texture2D>& texture, const glm::vec4& RendererColor = glm::vec4(1.0f), int entityID = 0);
		static void DrawQuad(const glm::mat4& transform, Ref<Subtexture2D>& subTexture, const glm::vec4& RendererColor = glm::vec4(1.0f), int entityID = 0);
