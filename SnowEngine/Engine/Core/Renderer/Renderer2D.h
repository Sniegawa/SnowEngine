...
namespace Snow
{
	...
	public:
		...
		static void DrawQuad(glm::vec2 pos, const glm::vec2& size, Ref<Texture>& texture);
		static void DrawQuad(glm::vec3 pos, const glm::vec2& size, Ref<Texture>& texture);
		...
		static void DrawRotatedQuad(glm::vec2 pos, const glm::vec2& size,float rotation, Ref<Texture>& texture);
		static void DrawRotatedQuad(glm::vec3 pos, const glm::vec2& size,float rotation, Ref<Texture>& texture);
